...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		case WM_CREATE: {													//Create a custom box
			CreateWindow(TEXT("STATIC"), TEXT("TEXT"), 						//First TEXT is the Type of the box, Second Text is the Caption.
				WS_VISIBLE | WS_CHILD, 										//Style of the Text
				10, 10,														//Coordinates of the box on the screen
				100, 25,													//Size of the box
